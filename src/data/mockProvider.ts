...
const modules: LmsModule[] = [
  {
    ...
    title: 'Introduction',
    ce_credits: null,
    bridge_copy: 'See the full path ahead before beginning the Financial Professional Track.',
  },
  {
    id: 'fpt-m1',
    course_id: 'course-fpt',
    ...
    ce_credits: 4.5,
    bridge_copy: 'Build the monetary and market foundation behind the asset clients ask about most.',
  },
  {
    id: 'fpt-m2',
    course_id: 'course-fpt',
    ...
    ce_credits: 4.5,
    bridge_copy: 'See how distributed ledgers create verifiable ownership and settlement beyond Bitcoin.',
  },
  {
    id: 'fpt-m3',
    course_id: 'course-fpt',
    position: 3,
    title: 'Digital Assets and Currencies',
    ce_credits: 4.5,
    bridge_copy: 'Distinguish the major asset types before evaluating their roles and risks.',
  },
  {
    id: 'fpt-m4',
    course_id: 'course-fpt',
    position: 4,
    title: 'Layer 2, Tokens, and DeFi',
    ce_credits: 4.5,
  ...
  },
  {
    ...
    position: 1,
    title: '2026 Annual Update',
    ce_credits: 1,
    bridge_copy: 'Refresh the developments that matter for the coming designation year.',
  },
];
